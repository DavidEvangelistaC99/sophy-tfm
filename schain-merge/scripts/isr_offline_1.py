...
outPath = '/home/david/Documents/DATA/ISR/'
...
#factors = [1.06]
#nChannels = 5 # 2 10?
nChannels = 1 #2 DESDE EL LUNES  01/09/2025 TENEMOS SOLO EL CANAL OBLICUO
IPPms =10
nFFT = 1
...
controllerObj.setup(id = '001', name='isr offline', description='desc')
...
opObj03.addParameter(name='channelList', value=nChannels -1 , format='list')
...
spc_plot.addParameter(name='save', value=outPath, format='str')
...
writer.addParameter(name='path', value=outPath)
